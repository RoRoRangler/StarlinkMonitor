...
nonisolated struct SpaceX_API_Device_GetPingResponse: Sendable {
  ...
  var results: [SpaceX_API_Device_GetPingResponse.ResultsEntry] = []

  var unknownFields = SwiftProtobuf.UnknownStorage()

  nonisolated struct ResultsEntry: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    var value: SpaceX_API_Device_PingResult {
      get {_value ?? SpaceX_API_Device_PingResult()}
      set {_value = newValue}
    }
    ...
    fileprivate var _value: SpaceX_API_Device_PingResult? = nil
  }
...
nonisolated struct SpaceX_API_Device_GetConnectionsResponse: Sendable {
  ...
  var services: [SpaceX_API_Device_GetConnectionsResponse.ServicesEntry] = []
  ...
  nonisolated struct ServicesEntry: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    var value: SpaceX_API_Device_GetConnectionsResponse.ServiceConnection {
      get {_value ?? SpaceX_API_Device_GetConnectionsResponse.ServiceConnection()}
      set {_value = newValue}
    }
    /// Returns true if `value` has been explicitly set.
    var hasValue: Bool {self._value != nil}
    ...
    fileprivate var _value: SpaceX_API_Device_GetConnectionsResponse.ServiceConnection? = nil
  }
...
nonisolated extension SpaceX_API_Device_GetPingResponse.ResultsEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = SpaceX_API_Device_GetPingResponse.protoMessageName + ".ResultsEntry"
  ...
  static func ==(lhs: SpaceX_API_Device_GetPingResponse.ResultsEntry, rhs: SpaceX_API_Device_GetPingResponse.ResultsEntry) -> Bool {
...
nonisolated extension SpaceX_API_Device_GetConnectionsResponse.ServicesEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = SpaceX_API_Device_GetConnectionsResponse.protoMessageName + ".ServicesEntry"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}key\0\u{1}value\0")
  ...
  static func ==(lhs: SpaceX_API_Device_GetConnectionsResponse.ServicesEntry, rhs: SpaceX_API_Device_GetConnectionsResponse.ServicesEntry) -> Bool {
    if lhs.key != rhs.key {return false}
    if lhs._value != rhs._value {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
