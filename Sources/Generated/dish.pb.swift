...
nonisolated struct SpaceX_API_Device_DishGetStatusResponse: @unchecked Sendable {
  ...
  var downstreamRouters: [SpaceX_API_Device_DishGetStatusResponse.DownstreamRoutersEntry] {
  ...
  nonisolated struct DownstreamRoutersEntry: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    var value: SpaceX_API_Device_RouterInfo {
      get {_value ?? SpaceX_API_Device_RouterInfo()}
      set {_value = newValue}
    }
    ...
    fileprivate var _value: SpaceX_API_Device_RouterInfo? = nil
  }
...
nonisolated extension SpaceX_API_Device_DishGetStatusResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _downstreamRouters: [SpaceX_API_Device_DishGetStatusResponse.DownstreamRoutersEntry] = []
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 1050: try { try decoder.decodeRepeatedMessageField(value: &_storage._downstreamRouters) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._downstreamRouters.isEmpty {
        try visitor.visitRepeatedMessageField(value: _storage._downstreamRouters, fieldNumber: 1050)
      }
...
nonisolated extension SpaceX_API_Device_DishGetStatusResponse.DownstreamRoutersEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = SpaceX_API_Device_DishGetStatusResponse.protoMessageName + ".DownstreamRoutersEntry"
  ...
  static func ==(lhs: SpaceX_API_Device_DishGetStatusResponse.DownstreamRoutersEntry, rhs: SpaceX_API_Device_DishGetStatusResponse.DownstreamRoutersEntry) -> Bool {
