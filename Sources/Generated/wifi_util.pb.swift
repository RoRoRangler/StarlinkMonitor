...
nonisolated struct SpaceX_API_Device_RadiusStatsMap: Sendable {
  ...
  var radiusStats: [SpaceX_API_Device_RadiusStatsMap.RadiusStatsEntry] = []
  ...
  nonisolated struct RadiusStatsEntry: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    var value: SpaceX_API_Device_RadiusStatsMap.RadiusStats {
      get {_value ?? SpaceX_API_Device_RadiusStatsMap.RadiusStats()}
      set {_value = newValue}
    }
    ...
    fileprivate var _value: SpaceX_API_Device_RadiusStatsMap.RadiusStats? = nil
  }
...
nonisolated extension SpaceX_API_Device_RadiusStatsMap: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedMessageField(value: &self.radiusStats) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.radiusStats.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.radiusStats, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
nonisolated extension SpaceX_API_Device_RadiusStatsMap.RadiusStatsEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = SpaceX_API_Device_RadiusStatsMap.protoMessageName + ".RadiusStatsEntry"
  ...
  static func ==(lhs: SpaceX_API_Device_RadiusStatsMap.RadiusStatsEntry, rhs: SpaceX_API_Device_RadiusStatsMap.RadiusStatsEntry) -> Bool {
