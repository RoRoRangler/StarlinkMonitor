...
nonisolated struct SpaceX_API_Device_WifiConfig: @unchecked Sendable {
  ...
  var meshConfigs: [SpaceX_API_Device_WifiConfig.MeshConfigsEntry] {
    get {_storage._meshConfigs}
    set {_uniqueStorage()._meshConfigs = newValue}
  }

  var meshConfigsUpdates: [SpaceX_API_Device_WifiConfig.MeshConfigsUpdatesEntry] {
  ...
  nonisolated struct MeshConfigsEntry: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    var value: SpaceX_API_Device_MeshConfig {
      get {_value ?? SpaceX_API_Device_MeshConfig()}
      set {_value = newValue}
    }
    ...
    fileprivate var _value: SpaceX_API_Device_MeshConfig? = nil
  }

  nonisolated struct MeshConfigsUpdatesEntry: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
nonisolated extension SpaceX_API_Device_WifiConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _meshConfigs: [SpaceX_API_Device_WifiConfig.MeshConfigsEntry] = []
    var _meshConfigsUpdates: [SpaceX_API_Device_WifiConfig.MeshConfigsUpdatesEntry] = []
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 33: try { try decoder.decodeRepeatedMessageField(value: &_storage._meshConfigs) }()
        ...
        case 3033: try { try decoder.decodeRepeatedMessageField(value: &_storage._meshConfigsUpdates) }()
        case 4001: try {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._meshConfigs.isEmpty {
        try visitor.visitRepeatedMessageField(value: _storage._meshConfigs, fieldNumber: 33)
      }
      ...
      if !_storage._meshConfigsUpdates.isEmpty {
        try visitor.visitRepeatedMessageField(value: _storage._meshConfigsUpdates, fieldNumber: 3033)
      }
...
nonisolated extension SpaceX_API_Device_WifiConfig.MeshConfigsEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = SpaceX_API_Device_WifiConfig.protoMessageName + ".MeshConfigsEntry"
  ...
  static func ==(lhs: SpaceX_API_Device_WifiConfig.MeshConfigsEntry, rhs: SpaceX_API_Device_WifiConfig.MeshConfigsEntry) -> Bool {
    if lhs.key != rhs.key {return false}
...
nonisolated extension SpaceX_API_Device_WifiConfig.MeshConfigsUpdatesEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = SpaceX_API_Device_WifiConfig.protoMessageName + ".MeshConfigsUpdatesEntry"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}key\0\u{1}value\0")
  ...
  static func ==(lhs: SpaceX_API_Device_WifiConfig.MeshConfigsUpdatesEntry, rhs: SpaceX_API_Device_WifiConfig.MeshConfigsUpdatesEntry) -> Bool {
    if lhs.key != rhs.key {return false}
    if lhs._value != rhs._value {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
